    ...
    while True:
        ...
        #If the input is not a number or has a decimal
            ...
            if input_again.lower()=="yes":
                ...
                print (border)
                exit()
    for x in range (int(how_many_number)):
        while True:            
            nth_term = int(x)+1
            if nth_term == 1:
                num_to_add = input("Enter 1st number: ")
                ...
                if is_int(num_to_add)==True:
                    ...
                    if input_again.lower()=="yes":
                        ...
                        exit()
            if nth_term == 2:
                num_to_add = input("Enter 2nd number: ")
            ...
            if nth_term == 3:
                num_to_add = input("Enter 3rd number: ")
                ...
                if is_int(num_to_add)==True:
                    ...
                    if input_again.lower()=="yes":
                        ...
                        exit()
            if nth_term>3:
                num_to_add = input("Enter "+ str(nth_term) + "th number: ")
